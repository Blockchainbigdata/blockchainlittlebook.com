...
> “哦！ 我明白了，这就好像是……” 
，就是一个在后面才能深入理解的概念竟然在此之前已经被引用了，导致的结果是学习者总是处于懵懂的状态。学校里的知识不是这样的，学校里的知识总是线性层层递进的，理解了前面，就能理解后面…… 关于 “前置引用”，你可以参阅我在《[自学是门手艺](https://github.com/selfteaching/the-craft-of-selfteaching/blob/master/Part.1.F.deal-with-forward-references.ipynb)》里的阐述。
...
> 投资是一场人生中新的旅行，区块链和数字货币的世界对于你来说一定是座新的城市.当你打开大门的那一刻你就要面临抉择，一步天堂或者地狱，又或者只是平淡无奇。走的快并不代表能走的远，每一步的选择都、可能要大于最后的努力，每一次的努力也都可能因为一次错误的选择摧毁殆尽。努力探寻的同时，你更需要的是一个能够正确引导你，并与你同行的同伴或一群同伴，因为在这个世界中，正确的伙伴和正确的选择，永远大于你的努力。

> 如果你也在摸黑前行，我真诚的邀请你加入我们的队伍.
